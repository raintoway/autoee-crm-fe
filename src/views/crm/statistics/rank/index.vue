...
<template>
  ...
  <el-col>
    <el-tabs v-model="activeTab">
      <!-- 订单金额排行 -->
      <el-tab-pane label="订单金额排行" name="contractPriceRank" lazy>
      ...
      <!-- 签约订单排行 -->
      <el-tab-pane label="签约订单排行" name="contractCountRank" lazy>
