...
<template>
  ...
  <el-col>
    <el-tabs v-model="activeTab">
      <!-- 员工订单统计 -->
      <el-tab-pane label="员工订单数量统计" name="ContractCountPerformance" lazy>
        <ContractCountPerformance :query-params="queryParams" ref="ContractCountPerformanceRef" />
      </el-tab-pane>
      <!-- 员工订单金额统计 -->
      <el-tab-pane label="员工订单金额统计" name="ContractPricePerformance" lazy>
...
const ContractCountPerformanceRef = ref() // 员工订单数量统计
const ContractPricePerformanceRef = ref() // 员工订单金额统计
